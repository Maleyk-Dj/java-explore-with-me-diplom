...
import ru.practicum.dto.events.convertors.StringToEventStateConverter;
...
public class UpdateEventUserRequest {
    ...
    @JsonProperty(value = "src/main/java/ru/yandex/practicum/category", access = JsonProperty.Access.WRITE_ONLY)
